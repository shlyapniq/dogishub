...
local char,mouse = plr.Character.Reanimate,plr:GetMouse()
...
local Hat1 = AlginChar:FindFirstChild("LavanderHair")
local Hat2 = AlginChar:FindFirstChild("Kate Hair")
local Hat3 = AlginChar:FindFirstChild("Pal Hair")
local Hat4 = AlginChar:FindFirstChild("Hat1")
local Hat5 = AlginChar:FindFirstChild("WDW_FoamFinger")
local Hat6 = AlginChar:FindFirstChild("MessyHair")
local Hat7 = AlginChar:FindFirstChild("Pink Hair")
local Count = 7
...
Hat3.Handle.AccessoryWeld:Destroy()
Hat4.Handle.AccessoryWeld:Destroy()
Hat5.Handle.AccessoryWeld:Destroy()
Hat6.Handle.AccessoryWeld:Destroy()
Hat7.Handle.AccessoryWeld:Destroy()
...
Hat5.Handle.SpecialMesh:Destroy()
...
AlginChar.Reanimate["LavanderHair"].Handle.Attachment:Destroy()
AlginChar.Reanimate["Kate Hair"].Handle.Attachment:Destroy()
AlginChar.Reanimate["Pal Hair"].Handle.Attachment:Destroy()
AlginChar.Reanimate["Hat1"].Handle.Attachment:Destroy()
AlginChar.Reanimate["WDW_FoamFinger"].Handle.Attachment:Destroy()
AlginChar.Reanimate["MessyHair"].Handle.Attachment:Destroy()
AlginChar.Reanimate["Pink Hair"].Handle.Attachment:Destroy()




Align(Hat1.Handle,AlginChar.Reanimate.Drone.Rotor1.Main ,Vector3.new(0,0,0),Vector3.new(0,0,0))
Align(Hat2.Handle,AlginChar.Reanimate.Drone.Rotor2.Main ,Vector3.new(0,0,0),Vector3.new(0,0,0))
Align(Hat3.Handle,AlginChar.Reanimate.Drone.Rotor3.Main ,Vector3.new(0,0,0),Vector3.new(0,0,0))
Align(Hat4.Handle,AlginChar.Reanimate.Drone.Rotor4.Main ,Vector3.new(0,0,0),Vector3.new(0,0,0))
Align(Hat5.Handle,AlginChar.Reanimate.Drone.Controller ,Vector3.new(0,-0.25,0),Vector3.new(90,90,0))
Align(Hat6.Handle,AlginChar.Reanimate.Drone.Controller ,Vector3.new(1.5, -0.78, 0),Vector3.new(0,0,45))
Align(Hat7.Handle,AlginChar.Reanimate.Drone.Controller ,Vector3.new(-1.5, -0.78, 0),Vector3.new(0,0,45))




for _,v in pairs(AlginChar.Reanimate.Drone:GetChildren()) do
					...
					if part then
						...
						elseif part.Parent.Parent:IsA("Model") then
							if part.Parent.Parent:FindFirstChild("Humanoid") then
								part.Parent.Parent.Humanoid.Health = part.Parent.Parent.Humanoid.Health - 0
							end
						end
					end
