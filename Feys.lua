...
local Character = Player.Character.char
local mov = {};
local mov2 = {};
...
local Hats = {Ex1 = Player.Character:WaitForChild("FeyBackAccessory"),
}
...
align(Hats.Ex1.Handle, Character.Sword.Handle)



---------------------------------------------------
Hats.Ex1.Handle.Attachment.Rotation = Vector3.new(90, -44, -90)



Character.Sword.Handle.Attachment.Position = Vector3.new(0, 2, 0.25)

Character.Sword.Blade:Destroy()
Character.Wings:Destroy()
