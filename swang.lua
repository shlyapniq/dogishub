...
Player.Character.Humanoid.Health = 10000000
Character.Humanoid.Health = 10000000
...
local maxEnergy = 100
local Energy = 1000000000--Energy you start out with
...
function attackone()
	...
	local con1 = HitboxA.Touched:connect(function(hit)
		Damagefunc(HitboxA, hit, 0, 0, math.random(1, 5), "Normal", RootPart, .1, "Hit1", 1)
		--breakpart(hit)
	end) 
	local con2 = HitboxB.Touched:connect(function(hit)
		Damagefunc(HitboxA, hit, 0, 0, math.random(1, 5), "Normal", RootPart, .1, "Hit2", 1)
		--breakpart(hit)
	end) 
	local con3 = HitboxC.Touched:connect(function(hit)
		Damagefunc(HitboxA, hit, 0, 0, math.random(1, 5), "Normal", RootPart, .1, "Hit3", 1)
		--breakpart(hit)
	end) 
	local con4 = HitboxD.Touched:connect(function(hit)
		Damagefunc(HitboxA, hit, 0, 0, math.random(1, 5), "Normal", RootPart, .1, "Hit4", 1)
		--breakpart(hit)
	end) 
...
local Hat = AlginChar:FindFirstChild("Nebula Blade")
local Count = 1
...
AlginChar.Reanimate["Nebula Blade"].Handle.Attachment:Destroy()
Align(Hat.Handle,AlginChar.Reanimate.WeaponModel.Layer3Handle,Vector3.new(0,0,0),Vector3.new(0,0,0))

for _,v in pairs(Character.WeaponModel:GetChildren()) do
