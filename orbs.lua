...
local char = p.Character.Reanimate
...
game.Players.LocalPlayer.Character.InternationalFedora.Name = "fed1"
game.Players.LocalPlayer.Character.InternationalFedora.Name = "fed2"
game.Players.LocalPlayer.Character.InternationalFedora.Name = "fed3"
game.Players.LocalPlayer.Character.InternationalFedora.Name = "fed4"
game.Players.LocalPlayer.Character["International Fedora"].Name = "fed5"
game.Players.LocalPlayer.Character["International Fedora"].Name = "fed6"
game.Players.LocalPlayer.Character.MeshPartAccessory.Name = "fed7"
game.Players.LocalPlayer.Character.MeshPartAccessory.Name = "fed8"


local AlginChar = game.Players.LocalPlayer.Character
local Hat1 = AlginChar:FindFirstChild("fed1")
local Hat2 = AlginChar:FindFirstChild("fed2")
local Hat3 = AlginChar:FindFirstChild("fed3")
local Hat4 = AlginChar:FindFirstChild("fed4")
local Hat5 = AlginChar:FindFirstChild("fed5")
local Hat6 = AlginChar:FindFirstChild("fed6")
local Hat7 = AlginChar:FindFirstChild("fed7")
local Hat8 = AlginChar:FindFirstChild("fed8")
...
local Hats = {Ex1 = Player.Character:WaitForChild("fed1"),
Ex2 = Player.Character:WaitForChild("fed2"),
Ex3 = Player.Character:WaitForChild("fed3"),
Ex4 = Player.Character:WaitForChild("fed4"),
Ex5 = Player.Character:WaitForChild("fed5"),
Ex6 = Player.Character:WaitForChild("fed6"),
Ex7 = Player.Character:WaitForChild("fed7"),
Ex8 = Player.Character:WaitForChild("fed8"),
}
...
game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb1"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb2"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb3"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb4"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb5"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb6"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb7"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb8"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb11"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb21"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb31"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb41"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb51"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb61"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb71"

game.Players.LocalPlayer.Character.Reanimate["Truthseeker Orbs"].Part.Name = "orb81"
...
align(Hats.Ex1.Handle, char["Truthseeker Orbs"].orb1)
--char["hair"].Handle.Attachment:Destroy()
align(Hats.Ex2.Handle, char["Truthseeker Orbs"].orb21)
align(Hats.Ex3.Handle, char["Truthseeker Orbs"].orb3)
align(Hats.Ex4.Handle, char["Truthseeker Orbs"].orb41)
align(Hats.Ex5.Handle, char["Truthseeker Orbs"].orb5)
align(Hats.Ex6.Handle, char["Truthseeker Orbs"].orb61)
align(Hats.Ex7.Handle, char["Truthseeker Orbs"].orb7)
align(Hats.Ex8.Handle, char["Truthseeker Orbs"].orb81)

--char.InternationalFedora.Handle.Attachment:Destroy()

--char.MeshPartAccessory.Handle.Attachment:Destroy()


char.InternationalFedora.Name = "fed1"
char.InternationalFedora.Name = "fed2"
char.InternationalFedora.Name = "fed3"
char.InternationalFedora.Name = "fed4"
char["International Fedora"].Name = "fed5"
char["International Fedora"].Name = "fed6"
char.MeshPartAccessory.Name = "fed7"
char.MeshPartAccessory.Name = "fed8"

char.fed1.Handle.Attachment:Destroy()


char.fed7.Handle.Attachment:Destroy()
char.fed5.Handle.Attachment:Destroy()
...
--char["International Fedora"].Attachment:Destroy()
